...
```http
POST /api/testcase/import?excelPath={excelPath}
...
```http
POST /api/testresult/import?excelPath={excelPath}
Content-Type: application/json
```
...
```http
POST /api/baseline/build?srsPath={srsDocxPath}&excelPath={excelPath}
```
